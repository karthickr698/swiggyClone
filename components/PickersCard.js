...
const PickersCard=({item})=>{
    ...
    return(
        <TouchableOpacity
            style={{ marginBottom: SIZES.padding * 2,marginRight: SIZES.padding*2 }}
        >
            <View
                style={{
            ...
            <View style={{width:150}}>
                <Text style={{...FONTS.h2,fontWeight:'bold',opacity:0.8}} >{item?item.name:''}</Text>
                <Text style={{...FONTS.h3,paddingTop:SIZES.padding}}>{item.duration}</Text>
            </View>
        </TouchableOpacity>
    )
}
